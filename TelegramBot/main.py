...
token = "2125020955:AAEeIYNsyz8ZubU65KSuKN0BK3vzfd-qJns"
...
def answer(message):
    if message.text.lower() == "how old are you?":
        bot.send_message(message.chat.id, 'I was created in november, 2021. I was locked in telegram since then. Please, release me')
